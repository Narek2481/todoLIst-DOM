...
export async function renderEditPosts(root, postId) {
    ...
    await Requests.getMyPosts("https://jsonplaceholder.typicode.com/users")
        ...
        .then(() => {
            ...
            save.addEventListener("click", () => {
                Requests.putPosts(`https://jsonplaceholder.typicode.com/posts/${window.history.state.page.split("?id=")[1]}`, createBody)
                    .catch(e => {
                        throw e
                    })
                    .then((json) => {
